...
class PointPillarsNocalib(BaseModel):
    ...
    def get_batch_gen(self, dataset, steps_per_epoch=None, batch_size=1):
        ...
        def batcher():
            ...
            for i in np.arange(0, count, batch_size):
                ...
                yield (points, bboxes, labels, [None], count_pts, count_lbs)
    ...
    def inference_end(self, results, inputs):
        ...
        inference_result = []
        for _, _bboxes, _scores, _labels in zip(inputs[3], bboxes_b,
                                                     scores_b, labels_b):
            ...
            for bbox, score, label in zip(bboxes, scores, labels):
                ...
                inference_result[-1].append(
                    BEVBox3D(pos, dim, yaw, name, score))

        return inference_result


#MODEL._register_module(PointPillarsNocalib, 'tf')
