...
class ObjectDetection(BasePipeline):
    ...
    def run_valid(self):
        ...
        print([np.mean(x['bbox']) for x in pred])
        print([np.mean(x['bbox']) for x in gt])
#[1.758049617920603, 3.983425789949845, 1.8926034539329761, 4.6506914036614555, 5.818232889686312, 5.1639688233492755, 8.248757025552175, 3.3162506871280217, 8.861852259295327, 3.4282062219248877]
#[1.265109233856201, 3.093189878804343, 92.93118790092922, 101.31677231258277, 111.38265477786746, 51.40988952060541, 51.13254094643253, 56.59581582209043, 60.2786955950771, 44.85087508129549]
        sum_loss = 0
        desc = "validation - "
